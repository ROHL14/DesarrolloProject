$("document").ready(function () {
  ...
  $("a[name=c5]").click(function (evt) {
    ...
    if (
      confirm(
        "¿Seguro que quieres eliminar esta categoría? Todos los artículos y los registros en esta categoría serán suprimidos también"
      ) == true
    ) {
  ...
  $(
    "tr[data-type=element] td[data-type=id], tr[data-type=element] td[data-type=name]"
  ).click(function () {
  ...
  // Manejador para la paginacin y mostrar por pagina
  function go(act, val) {
