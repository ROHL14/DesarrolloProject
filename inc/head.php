...
<title>Donde Fer - <?php echo $_title; ?></title>
...
switch ($_page) {
	case 1:
		echo '	<script type="text/javascript" src="media/js/home.js"></script>';
		break;
	case 2:
	...
	case 4:
		...
		echo '	<script type="text/javascript">setPage("in");</script>';
		break;
	case 5:
		echo '	<script type="text/javascript" src="media/js/check.js"></script>';
		echo '	<script type="text/javascript">setPage("out");</script>';
		break;
	case 6:
		echo '	<script type="text/javascript" src="media/js/logs.js"></script>';
		break;
	case 7:
		echo '	<script type="text/javascript" src="media/js/cats.js"></script>';
		break;
	case 8:
		echo '	<script type="text/javascript" src="media/js/new-cat.js"></script>';
		break;
	case 9:
		echo '	<script type="text/javascript" src="media/js/users.js"></script>';
		break;
	case 10:
		echo '	<script type="text/javascript" src="media/js/new-user.js"></script>';
		break;
	case 11:
		echo '	<script type="text/javascript" src="media/js/edit-user.js"></script>';
		break;
	case 12:
		echo '	<script type="text/javascript" src="media/js/settings.js"></script>';
		break;
	case 13:
		echo '	<script type="text/javascript" src="media/js/edit-item.js"></script>';
		break;
	case 14:
		echo '	<script type="text/javascript" src="media/js/edit-cat.js"></script>';
		break;
} ?>